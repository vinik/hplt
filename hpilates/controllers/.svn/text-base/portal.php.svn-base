...
class Portal extends Supercontroller {
	var $nome_controller = 'portal';
	function Portal()
	{
	...
	function index()
	{
		$data['titulo'] = $this->lang->line('menu.portal');
...
/* Location: ./system/application/controllers/portal.php */